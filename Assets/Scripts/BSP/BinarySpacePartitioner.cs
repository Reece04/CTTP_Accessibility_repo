...
public class BinarySpacePartitioner
{
    ...
    {
        this.rootNode = new RoomNode(new Vector2Int(0, 0), new Vector2Int(homeWidth, homeLength), null, 0);
    ...
    //chooses orientation based on size of space
    private Line GetLineDividingSpace(Vector2Int bottomLeftAreaCorner, Vector2Int topRightAreaCorner, int roomWidthMin, int roomLengthMin)
    {
        ...
        {
            orientation = Orientation.Vertcial;
        }
        else
        {
    ...
    //Creates coords for line by checking size of room and randomly choosing val by min width and min height
